  ...
  return (
    <>
      <div className="grid lg:grid-cols-2 grow">
            ...
            <div className="text-center mb-8">
              <Link href="/" className="inline-block mb-4">
                <img
                  ...
                  className="h-20 max-w-none mx-auto"
        ...
        <div className="relative lg:rounded-xl lg:border lg:border-border lg:m-5 order-1 lg:order-2 overflow-hidden 
          bg-gradient-to-br from-[#2EC4E6] via-[#1DA1F2] to-[#0B1E8A]">
            ...
            {/* Overlay biar teks lebih readable */}
            <div className="absolute inset-0 bg-white/10 backdrop-blur-[2px]"></div>

            <div className="relative z-10 flex flex-col justify-between h-full p-8 lg:p-16 min-h-[500px]">
                ...
                <div className="space-y-6">
                  <div>
                    <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4 leading-tight">
                      Portal Pensiunan
                      <br />
                      <span className="text-blue-100">Telkom Indonesia</span>
                    </h2>
                  ...
                  <p className="text-lg text-blue-100 leading-relaxed max-w-lg">
                    ...
                    dan komunitas pensiunan Telkom dalam satu
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-8">
                    ...
                    <div className="bg-white/95 backdrop-blur-sm rounded-lg p-4 shadow-sm">
                      ...
                      <p className="text-gray-600 text-xs">Dana kematian & dana sosial</p>
                    </div>
